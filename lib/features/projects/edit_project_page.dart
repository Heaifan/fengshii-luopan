      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text('项目名称 *',
                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppTheme.textLabel)),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintStyle: TextStyle(color: AppTheme.textHint, fontSize: 15, fontWeight: FontWeight.w500),
                  filled: true, fillColor: Color(0xFFFFF8ED),
              ...
              Wrap(
                ...
                children: _projectTypes.map((t) {
                  ...
                  return ChoiceChip(
                    label: Text(_typeLabel(t), style: TextStyle(fontSize: 14, color: selected ? Colors.white : AppTheme.textPrimary)),
                    selected: selected, selectedColor: const Color(0xFF5A4724),
                    backgroundColor: const Color(0xFFF0E8D5),
                    side: BorderSide(color: selected ? const Color(0xFF5A4724) : AppTheme.cardBorder),
              ...
              Wrap(
                ...
                children: _baZhaiModes.map((m) {
                  ...
                  return ChoiceChip(
                    label: Text(_baZhaiModeLabel(m), style: TextStyle(fontSize: 14, color: selected ? Colors.white : AppTheme.textPrimary)),
                    selected: selected, selectedColor: const Color(0xFF5A4724),
                    backgroundColor: const Color(0xFFF0E8D5),
                    side: BorderSide(color: selected ? const Color(0xFF5A4724) : AppTheme.cardBorder),
              ...
              if (_baZhaiMode == 'wholeHouse') ...[
                ...
                Wrap(
                  ...
                  children: _guas.map((g) {
                    ...
                    return ChoiceChip(
                      label: Text('${g}宅', style: TextStyle(fontSize: 14, color: selected ? Colors.white : AppTheme.textPrimary)),
                      selected: selected, selectedColor: const Color(0xFF5A4724),
                      backgroundColor: const Color(0xFFF0E8D5),
                      side: BorderSide(color: selected ? const Color(0xFF5A4724) : AppTheme.cardBorder),
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(_saving ? '保存中...' : '保存', style: const TextStyle(fontSize: 16)),
