...
class PalacePointsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final palaceLabel = DirectionSector.sectorGuaPalaceLabel(sector);
    final dirLabel = DirectionSector.shortSector8Label(sector);
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${info.directionText}｜${info.mountainLabel}',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppTheme.textSecondary,
                    ),
